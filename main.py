...
class VideoBot:
    ...
    async def text_message(self, message: types.Message):
        ...
        try:
            ...
            await self.bot.send_message(chat_id, "Произошла ошибка при обработке вашего запроса. Убедитесь, что вы отправили "
        ...
        try:
            ...
            if os.path.exists(video_path):
                with open(video_path, 'rb') as Video:
                    await self.bot.send_video(message.chat.id, Video, caption="*Ваше видео загружено *", parse_mode="Markdown")
...
if __name__ == '__main__':
    ...
    bot_instance.dp.message_handler(commands=['start'])(bot_instance.start_message)
    bot_instance.dp.message_handler()(bot_instance.text_message)
